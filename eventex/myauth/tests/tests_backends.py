...
class EmailBackendTest(TestCase):
    def setUp(self):
        ...
        UserModel.objects.create_user(username='marcio',
            email='marcio.ramos.correa@gmail.com', password='abracadabra')
        self.backend = EmailBackend()

    def test_authenticate_with_email(self):
        user = self.backend.authenticate(email='marcio.ramos.correa@gmail.com',
...
class FunctionalEmailBackendTest(TestCase):
    ...
    def test_login_with_email(self):
        result = self.client.login(email='marcio.ramos.correa@gmail.com',
            password='abracadabra')
        self.assertTrue(result)

    def test_login_with_username(self):
        result = self.client.login(username='marcio.ramos.correa@gmail.com',
            password='abracadabra')
        self.assertTrue(result)