...
class TalkListTest(TestCase):
    def setUp(self):
        s = Speaker.objects.create(name='Márcio Ramos Corrêa', slug='marcio-ramos-correa',
    ...
    def test_html(self):
        ...
        self.assertContains(self.resp,u'/palestrantes/marcio-ramos-correa/', 2)
        self.assertContains(self.resp,u'Passionate software developer!', 2)
        self.assertContains(self.resp,u'Márcio Ramos Corrêa', 2)
